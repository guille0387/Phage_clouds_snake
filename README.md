...
1. Once, register the upstream repository in your local copy: `git remote add -f upstream git@github.com:snakemake-workflows/Phage_clouds_snake.git` or `git remote add -f upstream https://github.com/snakemake-workflows/Phage_clouds_snake.git` if you do not have setup ssh keys.
